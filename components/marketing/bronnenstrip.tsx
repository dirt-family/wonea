 ...
 * logo's van derden. Huisstijl v3: dit is de koele navy-adem in de
 * homepage-dramaturgie (wash-navy tussen twee lichte secties).
 */
const STRIP_BRONNEN = ["Kadaster", "CBS", "RVO", "DNB", "OpenStreetMap"] as const;

export function Bronnenstrip() {
  return (
    <section aria-label="Databronnen" className="border-y border-merk-100 bg-wash-navy">
      <div className="mx-auto flex max-w-5xl flex-wrap items-baseline gap-x-10 gap-y-3 px-5 py-7">
        <p className="text-sm text-merk-600">Gebouwd op open data van</p>
