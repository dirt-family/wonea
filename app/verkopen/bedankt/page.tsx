...
export const metadata: Metadata = { title: "Aanvraag verstuurd", robots: { index: false, follow: false } };
    ...
    <div className="mx-auto max-w-2xl px-5 py-16">
      <div className="flex items-start justify-between gap-8">
        <div className="min-w-0">
          ...
          <h1 className="mt-5 text-3xl font-semibold">Je aanvraag is verstuurd</h1>
        ...
        <Illustratie naam="woningwaarde" className="hidden w-44 shrink-0 sm:block" />
      </div>
    </div>
  );
}
