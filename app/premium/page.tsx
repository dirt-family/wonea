    ...
    <div className="mx-auto max-w-5xl px-5 py-10">
      ...
      <div className="mt-8 grid gap-5 sm:grid-cols-2">
        {PRODUCT_VOLGORDE.map((product) => {
          ...
          return (
            <Kaart key={product} className={gekozen ? "border-merk" : ""}>
              <div className="flex flex-wrap items-center justify-between gap-3">
                <SectieLabel>Eenmalig product</SectieLabel>
                {gekozen ? (
      ...
      <Kaart className="mt-5">
        <SectieLabel>Eerlijk over premium</SectieLabel>
        <ul className="mt-3 space-y-2 text-sm leading-relaxed text-inkt-zacht">
          <li>
            Wonea zit in de testfase. Afrekenen is hier een oefen-checkout: er wordt niets afgeschreven en we vragen geen
            betaalgegevens.
          </li>
          <li>
            Beide producten zijn eenmalig. We zetten je dus niet in een abonnement en verlengen niets automatisch; dat
            vinden we net zo belangrijk als de verdieping zelf.
          </li>
          <li>
            De verdieping hangt aan je account (e-mail volstaat, geen wachtwoord) en verschijnt op de biedadvies- en
            marktanalyse-onderdelen van de adressen en buurten die je bekijkt.
          </li>
        </ul>
